...
public class HideItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hide_simplePosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hide_simplePosition_feature", "_UI_Hide_type"),
				 AnimationsPackage.Literals.HIDE__SIMPLE_POSITION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Hide)object).getSimplePosition();
