		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SurfaceColor_colorCode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SurfaceColor_colorCode_feature", "_UI_SurfaceColor_type"),
				 AppearancePackage.Literals.SURFACE_COLOR__COLOR_CODE,
				 true,
				 false,
				 false,
