...
/**
 * This is the item provider adapter for a {@link appearance.Texture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextureItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Texture_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Texture_file_feature", "_UI_Texture_type"),
				 AppearancePackage.Literals.TEXTURE__FILE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Texture)object).getLabel();
