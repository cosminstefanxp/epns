...
public class TrackReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof geometry.trackPosition && newEnd instanceof geometry.trackPosition)) {
			return false;
		}
		geometry.trackPosition target = getLink().getEndPosition();
	...
	protected boolean canReorientTarget() {
		...
		geometry.trackPosition source = getLink().getStartPosition();
		if (!(getLink().eContainer() instanceof Geometry)) {
			return false;
		}
		Geometry container = (Geometry) getLink().eContainer();
	 ...
	 * @generated
	 */
	protected geometry.trackPosition getOldSource() {
		return (geometry.trackPosition) oldEnd;
	}

	/**
	 * @generated
	 */
	protected geometry.trackPosition getNewSource() {
		return (geometry.trackPosition) newEnd;
	}

	/**
	 * @generated
	 */
	protected geometry.trackPosition getOldTarget() {
		return (geometry.trackPosition) oldEnd;
	}
	 ...
	 * @generated
	 */
	protected geometry.trackPosition getNewTarget() {
		return (geometry.trackPosition) newEnd;
	}
}
