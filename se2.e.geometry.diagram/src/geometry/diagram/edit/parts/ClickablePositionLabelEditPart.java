 ...
 * @generated
 */
public class ClickablePositionLabelEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ClickablePositionLabelEditPart(View view) {
		super(view);
	}
			...
			parser = GeometryParserProvider
					.getParser(
							...
							GeometryVisualIDRegistry
									.getType(geometry.diagram.edit.parts.ClickablePositionLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
