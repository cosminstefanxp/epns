 ...
 * @generated
 */
public class TrackPositionLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TrackPositionLabelEditPart(View view) {
		super(view);
	}
			...
			parser = GeometryParserProvider
					.getParser(
							...
							GeometryVisualIDRegistry
									.getType(geometry.diagram.edit.parts.TrackPositionLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
