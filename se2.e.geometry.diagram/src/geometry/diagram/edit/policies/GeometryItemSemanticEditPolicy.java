...
import geometry.diagram.edit.commands.ClickablePositionCreateCommand;
import geometry.diagram.edit.commands.TrackPositionCreateCommand;
...
public class GeometryItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (GeometryElementTypes.ClickablePosition_2001 == req.getElementType()) {
			return getGEFWrapper(new ClickablePositionCreateCommand(req));
		}
