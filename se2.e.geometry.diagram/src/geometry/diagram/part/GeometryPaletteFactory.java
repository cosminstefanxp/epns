...
public class GeometryPaletteFactory {
	...
	private PaletteContainer createGeometry1Group() {
		...
		paletteContainer.add(createClickablePosition2CreationTool());
	...
	private ToolEntry createTrack1CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				Messages.Track1CreationTool_title,
				Messages.Track1CreationTool_desc,
		...
		entry.setSmallIcon(GeometryElementTypes
				.getImageDescriptor(GeometryElementTypes.Track_4001));
	 ...
	 * @generated
	 */
	private ToolEntry createClickablePosition2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.ClickablePosition2CreationTool_title,
				Messages.ClickablePosition2CreationTool_desc,
				Collections
						.singletonList(GeometryElementTypes.ClickablePosition_2001));
		entry.setId("createClickablePosition2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(GeometryElementTypes
				.getImageDescriptor(GeometryElementTypes.ClickablePosition_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createTrackPosition3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.TrackPosition3CreationTool_title,
				Messages.TrackPosition3CreationTool_desc,
				Collections
						.singletonList(GeometryElementTypes.TrackPosition_2002));
		entry.setId("createTrackPosition3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(GeometryElementTypes
				.getImageDescriptor(GeometryElementTypes.TrackPosition_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
