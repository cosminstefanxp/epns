...
public class GeometryElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType ClickablePosition_2001 = getElementType("se2.e.geometry.diagram.ClickablePosition_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ClickablePosition_2001,
					GeometryPackage.eINSTANCE.getClickablePosition());

			elements.put(TrackPosition_2002,
					GeometryPackage.eINSTANCE.gettrackPosition());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(ClickablePosition_2001);
