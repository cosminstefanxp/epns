...
public class GeometryViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return ClickablePositionEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ClickablePositionEditPart.VISUAL_ID:
			return createClickablePosition_2001(domainElement, containerView,
	 ...
	 * @generated
	 */
	public Node createClickablePosition_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GeometryVisualIDRegistry
				.getType(ClickablePositionEditPart.VISUAL_ID));
