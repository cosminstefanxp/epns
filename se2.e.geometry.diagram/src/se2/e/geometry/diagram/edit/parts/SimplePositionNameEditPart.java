...
import se2.e.geometry.diagram.edit.policies.GeometryTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SimplePositionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimplePositionNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new GeometryEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GeometryParserProvider.getParser(GeometryElementTypes.SimplePosition_2001, getParserElement(),
					GeometryVisualIDRegistry
							.getType(se2.e.geometry.diagram.edit.parts.SimplePositionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, GeometryEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
