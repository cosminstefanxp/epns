...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				GeometryVisualIDRegistry.getType(se2.e.geometry.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new GeometryEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GeometryParserProvider
					.getParser(GeometryElementTypes.Track_4001, getParserElement(), GeometryVisualIDRegistry
							.getType(se2.e.geometry.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
