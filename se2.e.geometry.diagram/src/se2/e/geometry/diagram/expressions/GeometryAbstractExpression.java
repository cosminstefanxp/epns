 ...
 * @generated
 */
public abstract class GeometryAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = GeometryDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected GeometryAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
