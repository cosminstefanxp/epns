...
public class GeometryDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public GeometryDomainNavigatorContentProvider() {
		myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(GeometryDiagramEditorPlugin.getInstance()
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof GeometryDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(((GeometryDomainNavigatorItem) parentElement)
