	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case TrackPositionEditPart.VISUAL_ID: {
			...
			GeometryNavigatorGroup incominglinks = new GeometryNavigatorGroup(
					Messages.NavigatorGroupName_TrackPosition_2002_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GeometryNavigatorGroup outgoinglinks = new GeometryNavigatorGroup(
					Messages.NavigatorGroupName_TrackPosition_2002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					GeometryVisualIDRegistry.getType(TrackEditPart.VISUAL_ID));
		...
		case GeometryEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					GeometryVisualIDRegistry.getType(SimplePositionEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					GeometryVisualIDRegistry.getType(TrackPositionEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
		...
		case TrackEditPart.VISUAL_ID: {
			LinkedList<GeometryAbstractNavigatorItem> result = new LinkedList<GeometryAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			GeometryNavigatorGroup target = new GeometryNavigatorGroup(Messages.NavigatorGroupName_Track_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			GeometryNavigatorGroup source = new GeometryNavigatorGroup(Messages.NavigatorGroupName_Track_4001_source,
