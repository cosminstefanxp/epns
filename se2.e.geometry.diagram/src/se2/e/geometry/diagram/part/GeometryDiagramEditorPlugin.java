...
public class GeometryDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "se2.e.geometry.diagram"; //$NON-NLS-1$
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, GeometryDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, GeometryDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
