...
public class GeometryDiagramUpdater {
	...
	public static List<GeometryNodeDescriptor> getGeometry_1000SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getGeoObjects().iterator(); it.hasNext();) {
			...
			if (visualID == SimplePositionEditPart.VISUAL_ID) {
	...
	public static List<GeometryLinkDescriptor> getContainedLinks(View view) {
		...
		case SimplePositionEditPart.VISUAL_ID:
			return getSimplePosition_2001ContainedLinks(view);
	...
	public static List<GeometryLinkDescriptor> getIncomingLinks(View view) {
		switch (GeometryVisualIDRegistry.getVisualID(view)) {
		case SimplePositionEditPart.VISUAL_ID:
			return getSimplePosition_2001IncomingLinks(view);
		case TrackPositionEditPart.VISUAL_ID:
	...
	public static List<GeometryLinkDescriptor> getOutgoingLinks(View view) {
		switch (GeometryVisualIDRegistry.getVisualID(view)) {
		case SimplePositionEditPart.VISUAL_ID:
			return getSimplePosition_2001OutgoingLinks(view);
		case TrackPositionEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getSimplePosition_2001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getTrackPosition_2002ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getTrack_4001ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getSimplePosition_2001IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getTrackPosition_2002IncomingLinks(View view) {
		TrackPosition modelElement = (TrackPosition) view.getElement();
		...
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
		result.addAll(getIncomingTypeModelFacetLinks_Track_4001(modelElement, crossReferences));
		return result;
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getTrack_4001IncomingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getSimplePosition_2001OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getTrackPosition_2002OutgoingLinks(View view) {
		TrackPosition modelElement = (TrackPosition) view.getElement();
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
	 ...
	 * @generated
	 */
	public static List<GeometryLinkDescriptor> getTrack_4001OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	private static Collection<GeometryLinkDescriptor> getContainedTypeModelFacetLinks_Track_4001(Geometry container) {
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
		for (Iterator<?> links = container.getGeoObjects().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof Track) {
				continue;
			}
			Track link = (Track) linkObject;
			if (TrackEditPart.VISUAL_ID != GeometryVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			TrackPosition dst = link.getEndPosition();
			TrackPosition src = link.getStartPosition();
			result.add(new GeometryLinkDescriptor(src, dst, link, GeometryElementTypes.Track_4001,
	 ...
	 * @generated
	 */
	private static Collection<GeometryLinkDescriptor> getIncomingTypeModelFacetLinks_Track_4001(TrackPosition target,
			Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences) {
		LinkedList<GeometryLinkDescriptor> result = new LinkedList<GeometryLinkDescriptor>();
		Collection<EStructuralFeature.Setting> settings = crossReferences.get(target);
		for (EStructuralFeature.Setting setting : settings) {
			if (setting.getEStructuralFeature() != GeometryPackage.eINSTANCE.getTrack_EndPosition()
			...
			TrackPosition src = link.getStartPosition();
			result.add(new GeometryLinkDescriptor(src, target, link, GeometryElementTypes.Track_4001,
					TrackEditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection<GeometryLinkDescriptor> getOutgoingTypeModelFacetLinks_Track_4001(TrackPosition source) {
