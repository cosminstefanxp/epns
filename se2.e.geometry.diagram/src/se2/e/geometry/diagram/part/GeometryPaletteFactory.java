...
public class GeometryPaletteFactory {
	...
	private ToolEntry createSimplePosition2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.SimplePosition2CreationTool_title,
				Messages.SimplePosition2CreationTool_desc,
				Collections
						.singletonList(GeometryElementTypes.SimplePosition_2001));
		entry.setId("createSimplePosition2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(GeometryElementTypes
				.getImageDescriptor(GeometryElementTypes.SimplePosition_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
