...
public class GeometryVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return se2.e.geometry.diagram.part.GeometryVisualIDRegistry.getVisualID(view.getType());
	}
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = se2.e.geometry.diagram.part.GeometryVisualIDRegistry.getModelID(containerView);
		if (!GeometryEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (GeometryEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = se2.e.geometry.diagram.part.GeometryVisualIDRegistry.getVisualID(containerView);
		} else {
		...
		case GeometryEditPart.VISUAL_ID:
			if (GeometryPackage.eINSTANCE.getSimplePosition().isSuperTypeOf(domainElement.eClass())) {
				return SimplePositionEditPart.VISUAL_ID;
			}
			if (GeometryPackage.eINSTANCE.getTrackPosition().isSuperTypeOf(domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case SimplePositionEditPart.VISUAL_ID:
			if (SimplePositionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (GeometryPackage.eINSTANCE.getTrack().isSuperTypeOf(domainElement.eClass())) {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		public int getVisualID(View view) {
			return se2.e.geometry.diagram.part.GeometryVisualIDRegistry.getVisualID(view);
		}
		...
		public String getModelID(View view) {
			return se2.e.geometry.diagram.part.GeometryVisualIDRegistry.getModelID(view);
		}
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return se2.e.geometry.diagram.part.GeometryVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return se2.e.geometry.diagram.part.GeometryVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		public boolean isCompartmentVisualID(int visualID) {
			return se2.e.geometry.diagram.part.GeometryVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return se2.e.geometry.diagram.part.GeometryVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
