...
public class ModelElementSelectionPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		modelViewer.setContentProvider(new AdapterFactoryContentProvider(GeometryDiagramEditorPlugin.getInstance()
				.getItemProvidersAdapterFactory()));
		modelViewer.setLabelProvider(new AdapterFactoryLabelProvider(GeometryDiagramEditorPlugin.getInstance()
				.getItemProvidersAdapterFactory()));
		if (selectedModelElement != null) {
			modelViewer.setInput(selectedModelElement.eResource());
			modelViewer.setSelection(new StructuredSelection(selectedModelElement));
