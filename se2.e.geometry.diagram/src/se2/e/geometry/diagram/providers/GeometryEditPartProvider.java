...
import se2.e.geometry.diagram.edit.parts.GeometryEditPartFactory;
import se2.e.geometry.diagram.part.GeometryVisualIDRegistry;

/**
 * @generated
 */
public class GeometryEditPartProvider extends AbstractEditPartProvider {
	...
	public GeometryEditPartProvider() {
		setFactory(new GeometryEditPartFactory());
