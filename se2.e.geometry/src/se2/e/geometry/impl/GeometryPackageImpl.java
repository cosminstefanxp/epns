...
public class GeometryPackageImpl extends EPackageImpl implements GeometryPackage {
	 ...
	 * @generated
	 */
	private EClass simplePositionEClass = null;
	 ...
	 * @see se2.e.geometry.GeometryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getGeometryObject_ID() {
	 ...
	 * @generated
	 */
	public EAttribute getTrack_AppearanceLabel() {
	 ...
	 * @generated
	 */
	public EClass getSimplePosition() {
		return simplePositionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSimplePosition_Position() {
		return (EReference)simplePositionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSimplePosition_AppearanceLabel() {
		return (EAttribute)simplePositionEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(geometryObjectEClass, GEOMETRY_OBJECT__ID);
		...
		createEAttribute(trackEClass, TRACK__APPEARANCE_LABEL);

		positionEClass = createEClass(POSITION);
		createEAttribute(positionEClass, POSITION__X);
		createEAttribute(positionEClass, POSITION__Y);

		simplePositionEClass = createEClass(SIMPLE_POSITION);
		createEReference(simplePositionEClass, SIMPLE_POSITION__POSITION);
		createEAttribute(simplePositionEClass, SIMPLE_POSITION__APPEARANCE_LABEL);
	...
	public void initializePackageContents() {
		...
		trackEClass.getESuperTypes().add(this.getName_());
		simplePositionEClass.getESuperTypes().add(this.getGeometryObject());
		simplePositionEClass.getESuperTypes().add(this.getName_());
		...
		initEAttribute(getGeometryObject_ID(), ecorePackage.getEInt(), "ID", null, 0, 1, GeometryObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
