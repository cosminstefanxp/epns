 ...
 * <ul>
 *   <li>{@link se2.e.geometry.impl.TrackImpl#getName <em>Name</em>}</li>
 *   <li>{@link se2.e.geometry.impl.TrackImpl#getStartPosition <em>Start Position</em>}</li>
 *   <li>{@link se2.e.geometry.impl.TrackImpl#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link se2.e.geometry.impl.TrackImpl#getIntermediatePositions <em>Intermediate Positions</em>}</li>
 *   <li>{@link se2.e.geometry.impl.TrackImpl#getAppearanceLabel <em>Appearance Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TrackImpl extends GeometryObjectImpl implements Track {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeometryPackage.TRACK__NAME, oldName, name));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Name.class) {
			switch (derivedFeatureID) {
				case GeometryPackage.TRACK__NAME: return GeometryPackage.NAME__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Name.class) {
			switch (baseFeatureID) {
				case GeometryPackage.NAME__NAME: return GeometryPackage.TRACK__NAME;
				default: return -1;
			}
		}
