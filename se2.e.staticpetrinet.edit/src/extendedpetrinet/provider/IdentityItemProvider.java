...
public class IdentityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Identity_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Identity_text_feature", "_UI_Identity_type"),
				 ExtendedpetrinetPackage.Literals.IDENTITY__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Identity_type") + " " + identity.getText();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Identity.class)) {
			case ExtendedpetrinetPackage.IDENTITY__TEXT:
