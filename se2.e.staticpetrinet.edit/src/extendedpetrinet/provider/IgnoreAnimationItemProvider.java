...
public class IgnoreAnimationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IgnoreAnimation_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IgnoreAnimation_value_feature", "_UI_IgnoreAnimation_type"),
				 ExtendedpetrinetPackage.Literals.IGNORE_ANIMATION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_IgnoreAnimation_type") + " " + ignoreAnimation.isValue();
	}
