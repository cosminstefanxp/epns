...
public interface ExtendedpetrinetPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Geo Label</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int IDENTITY__VALUE = PnmlcoremodelPackage.ATTRIBUTE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int IGNORE_ANIMATION__VALUE = PnmlcoremodelPackage.ATTRIBUTE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INTERACTIVE_INPUT__VALUE = PnmlcoremodelPackage.ATTRIBUTE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ANIMATIONS_FEATURE_COUNT = StructuredpntypemodelPackage.STRUCTURED_LABEL_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference '{@link extendedpetrinet.Place#getGeoLabel <em>Geo Label</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Geo Label</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link extendedpetrinet.Identity#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see extendedpetrinet.Identity#getValue()
	 * @see #getIdentity()
	 * @generated
	 */
	EAttribute getIdentity_Value();
	...
	/**
	 * Returns the meta object for the attribute '{@link extendedpetrinet.IgnoreAnimation#isValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see extendedpetrinet.IgnoreAnimation#isValue()
	 * @see #getIgnoreAnimation()
	 * @generated
	 */
	EAttribute getIgnoreAnimation_Value();
	...
	/**
	 * Returns the meta object for the attribute '{@link extendedpetrinet.InteractiveInput#isValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see extendedpetrinet.InteractiveInput#isValue()
	 * @see #getInteractiveInput()
	 * @generated
	 */
	EAttribute getInteractiveInput_Value();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Geo Label</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EAttribute IDENTITY__VALUE = eINSTANCE.getIdentity_Value();
		 ...
		 * @generated
		 */
		EAttribute IGNORE_ANIMATION__VALUE = eINSTANCE.getIgnoreAnimation_Value();
		 ...
		 * @generated
		 */
		EAttribute INTERACTIVE_INPUT__VALUE = eINSTANCE.getInteractiveInput_Value();
