...
/**
 * This is the item provider adapter for a {@link animations.Sequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sequence_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sequence_components_feature", "_UI_Sequence_type"),
				 AnimationsPackage.Literals.SEQUENCE__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
