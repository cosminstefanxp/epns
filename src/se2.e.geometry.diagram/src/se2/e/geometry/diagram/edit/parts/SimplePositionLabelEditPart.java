 ...
 * @generated
 */
public class SimplePositionLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimplePositionLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new GeometryEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GeometryParserProvider
					.getParser(
							GeometryElementTypes.SimplePosition_2001,
							getParserElement(),
							GeometryVisualIDRegistry
									.getType(se2.e.geometry.diagram.edit.parts.SimplePositionLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
