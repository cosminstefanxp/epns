 ...
 *   <li>{@link se2.e.geometry.impl.TrackImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TrackImpl extends GeometryObjectImpl implements Track {
	...
	public void setLabel(String newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeometryPackage.TRACK__LABEL, oldLabel, label));
	}
