 ...
 * <ul>
 *   <li>{@link extendedpetrinet.impl.IdentityImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentityImpl extends AttributeImpl implements Identity {
	...
	public void setText(int newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedpetrinetPackage.IDENTITY__TEXT, oldText, text));
	}
